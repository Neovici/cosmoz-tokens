import{b as s}from"./iframe-VcrTb-bN.js";import{s as i,u as v}from"./style-sG1rYyyS.js";const x={title:"Tokens/Utilities"},e=s`<style>
    ${v}
</style>`,o={render:()=>s`
        ${i} ${e}
  ...
  render: () => html\`
    ...
    \`
}`,...a.parameters?.docs?.source}}};const h=["Flexbox","Gap","Padding","Margin","Text","Layout","Misc"];export{o as Flexbox,t as Gap,c as Layout,n as Margin,a as Misc,d as Padding,l as Text,h as __namedExportsOrder,x as default};
